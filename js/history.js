 ...
 * PixStar
 * File        : js/history.js
 * Description : Snapshot-based undo/redo. We snapshot the full layer
 *                stack's pixel data (cheap enough at pixel-art resolutions,
 *                even 256x256 with several layers) before a mutation
 *                begins, and can restore it on undo. This is far simpler
 *                and less bug-prone than per-pixel diffing, at a small
 *                memory cost that is bounded by MAX_HISTORY.
 */
...
export function restoreLayers(snapshot) {
