...
// or absurdly large scale (bugs #10/#11 in the spec: "Scale ติดลบ",
// "ขนาดเป็น 0"). Chosen so the layer stays visible/manipulable at both ends.
 ...
 * get baked into the layer (fixes the "ตำแหน่งเพี้ยน" / "Resize ผิด
 * ทิศเมื่อรูปถูกหมุน" class of bug that two slightly-different formulas
