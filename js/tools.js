 ...
 * PixStar
 * File        : js/tools.js
 * Description : All drawing-tool logic lives here, decoupled from
 *                rendering and input. Every function operates on a
 *                layer's Uint32Array pixel buffer and plain (x, y)
 *                integer pixel coordinates. Nothing here touches the DOM
 *                or canvas.
 */
