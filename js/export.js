 ...
 * PixStar
 * File        : js/export.js
 * Description : Turns the current document into downloadable files: PNG (with optional
 ...
 */
import { snapshotLayers, restoreLayers } from './history.js';
import { render, markCompositeDirty, exportCanvas } from './canvas.js';
 ...
 */
export async function exportAnimationFrames(filename, scale = 1) {
